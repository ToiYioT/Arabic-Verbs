...
buktol.Ihna = buildPronoun("בְּנֻפְעֺל", []);
...
bimsek.Ihna = buildPronoun("בְּנִפְעֵל", []);
...
bisma.Ihna = buildPronoun("בְּנִפְעַל", []);
...
biruh.Ihna = buildPronoun("בִּנְפוּל", []);
...
bijib.Ihna = buildPronoun("בִּנְפִיל", []);
...
bihki.Ihna = buildPronoun("בְּנִפְעִי", [BINSA]);
...
binsa.Ihna = buildPronoun("בְּנִפְעַא", [BIRUH]);
...
bihibb.Ihna = buildPronoun("בִּנְפִעّ", []);
...
bihutt.Ihna = buildPronoun("בִּנְפֻעّ", []);
