...
// future verbs
const yuktobHebrew = ["יבקש", "יקדים", "יגור", "יעבור", "יכה", "יעבור", "ירוץ", "ישב", "יודה", "יברח", "יבשל", "ישתוק", "ירגיש", "ילמד", "יצבע", "יצחצח", "ינשוף", "יתעטש"];
const yuktobArabic = ["טלבּ", "סבּק", "סכּן", "נקל", "צ'רבּ", "מרק", "רכּץ'", "קעד", "שכּר", "הרבּ", "טבּח'", "סכּת", "שער", "דרס", "צבּע'", "פרכּ", "נפח'", "עטס"];
